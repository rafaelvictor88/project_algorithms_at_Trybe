# Solução retirada do course e usa o método merge de ordenação;
def sort_word(array):
    ...
    left, right = sort_word(array[:mid]), sort_word(array[mid:])
...
def is_anagram(first_string, second_string):
    ...
    string1 = sort_word(first_array)
    string2 = sort_word(second_array)
